pub use crate::primitives::{qreal, QString};
...
impl QColor {
    ...
    pub fn from_rgb_f(r: qreal, g: qreal, b: qreal, a: Option<qreal>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 1.0,
        };
    ...
    pub fn from_cmyk(c: i32, m: i32, y: i32, k: i32, a: Option<i32>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 255,
        };
    ...
    pub fn from_cmyk_f(c: qreal, m: qreal, y: qreal, k: qreal, a: Option<qreal>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 1.0,
        };
    ...
    pub fn from_hsl(h: i32, s: i32, l: i32, a: Option<i32>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 255,
        };
    ...
    pub fn from_hsl_f(h: qreal, s: qreal, l: qreal, a: Option<qreal>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 1.0,
        };
    ...
    pub fn from_hsv(h: i32, s: i32, v: i32, a: Option<i32>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 255,
        };
    ...
    pub fn from_hsv_f(h: qreal, s: qreal, v: qreal, a: Option<qreal>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 1.0,
        };
    ...
    pub fn from_rgb(r: i32, g: i32, b: i32, a: Option<i32>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => 255,
        };
    ...
    pub fn from_rgba64(r: u16, g: u16, b: u16, a: Option<u16>) -> QColor {
        let a = match a {
            Some(a) => a,
            None => u16::MAX,
        };
    ...
    pub fn from_rgba(rgba: QRgb) -> QColor {
        cpp!(unsafe [rgba as "QRgb"] -> QColor as "QColor" {
...
mod tests {
    ...
    #[test]
    fn test_cmyk() {
        let mut color = QColor::from_cmyk(255, 200, 100, 0, None);
